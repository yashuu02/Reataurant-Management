...
labelinformation = Label(Tops, font=( 'aria' ,30, 'bold' ),text="Y S Restaurant",fg="indian red",bd=10,anchor='w')
labelinformation.grid(row=0,column=0)
labelinformation = Label(Tops, font=( 'aria' ,20,),text=localtime,fg="maroon",anchor=W)
labelinformation.grid(row=1,column=0)
text_Input=StringVar()
operator =""
textdisplay = Entry(frame2,font=('ariel' ,20,'bold'), textvariable=text_Input , bd=5,insertwidth=7 ,bg="snow",justify='right')
...
def Ref():
    ...
    costofmeal = "Rs.",str('%.2f'% (costoffries + costoflargefries + costofhamburger +
    costoffilet + costofcheesehamburger + costofdrinks))
...
button7=Button(frame2,padx=16,pady=16,bd=4, fg="black", font=('ariel', 20,'bold'),text="7",bg="old lace", command=lambda: buttonclick(7) )
button7.grid(row=2,column=0)
button8=Button(frame2,padx=16,pady=16,bd=4, fg="black", font=('ariel', 20,'bold'),text="8",bg="old lace", command=lambda: buttonclick(8) )
button8.grid(row=2,column=1)
button9=Button(frame2,padx=16,pady=16,bd=4, fg="black", font=('ariel', 20,'bold'),text="9",bg="old lace", command=lambda: buttonclick(9) )
button9.grid(row=2,column=2)
Addition=Button(frame2,padx=16,pady=16,bd=4, fg="black", font=('ariel', 20,'bold'),text="+",bg="old lace", command=lambda: buttonclick("+") )
Addition.grid(row=2,column=3)
button4=Button(frame2,padx=16,pady=16,bd=4, fg="black", font=('ariel', 20,'bold'),text="4",bg="old lace", command=lambda: buttonclick(4) )
button4.grid(row=3,column=0)
button5=Button(frame2,padx=16,pady=16,bd=4, fg="black", font=('ariel', 20,'bold'),text="5",bg="old lace", command=lambda: buttonclick(5) )
button5.grid(row=3,column=1)
button6=Button(frame2,padx=16,pady=16,bd=4, fg="black", font=('ariel', 20,'bold'),text="6",bg="old lace", command=lambda: buttonclick(6) )
button6.grid(row=3,column=2)
hamburgerstraction=Button(frame2,padx=16,pady=16,bd=4, fg="black", font=('ariel', 20,'bold'),text="-",bg="old lace", command=lambda: buttonclick("-") )
hamburgerstraction.grid(row=3,column=3)
button1=Button(frame2,padx=16,pady=16,bd=4, fg="black", font=('ariel', 20,'bold'),text="1",bg="old lace", command=lambda: buttonclick(1) )
button1.grid(row=4,column=0)
button2=Button(frame2,padx=16,pady=16,bd=4, fg="black", font=('ariel', 20,'bold'),text="2",bg="old lace", command=lambda: buttonclick(2) )
button2.grid(row=4,column=1)
button3=Button(frame2,padx=16,pady=16,bd=4, fg="black", font=('ariel', 20,'bold'),text="3",bg="old lace", command=lambda: buttonclick(3) )
button3.grid(row=4,column=2)
multiply=Button(frame2,padx=16,pady=16,bd=4, fg="black", font=('ariel', 20,'bold'),text="*",bg="old lace", command=lambda: buttonclick("*") )
multiply.grid(row=4,column=3)
button0=Button(frame2,padx=16,pady=16,bd=4, fg="black", font=('ariel', 20,'bold'),text="0",bg="old lace", command=lambda: buttonclick(0) )
button0.grid(row=5,column=0)
buttonc=Button(frame2,padx=16,pady=16,bd=4, fg="black", font=('ariel', 20,'bold'),text="c",bg="old lace", command=clrdisplay)
buttonc.grid(row=5,column=1)
buttonequal=Button(frame2,padx=16,pady=16,bd=4,width = 16, fg="black", font=('ariel',20 ,'bold'),text="=",bg="old lace",command=eqals)
buttonequal.grid(columnspan=4)
Decimal=Button(frame2,padx=16,pady=16,bd=4, fg="black", font=('ariel', 20,'bold'),text=".",bg="old lace", command=lambda: buttonclick(".") )
Decimal.grid(row=5,column=2)
Division=Button(frame2,padx=16,pady=16,bd=4, fg="black", font=('ariel', 20,'bold'),text="/",bg="old lace", command=lambda: buttonclick("/") )
Division.grid(row=5,column=3)
status = Label(frame2,font=('aria', 15, 'bold'),width = 16, text="-By Yashwarya ",bd=2,relief=SUNKEN)
...
textref = Entry(frame1,font=('ariel' ,16,'bold'), textvariable=rand ,
bd=6,insertwidth=4,bg="misty rose" ,justify='right')
...
textLargefries = Entry(frame1,font=('ariel' ,16,'bold'), textvariable=Largefries ,bd=6,insertwidth=4,bg="mistyrose" ,justify='right')
...
textFilet = Entry(frame1,font=('ariel' ,16,'bold'), textvariable=Filet ,bd=6,insertwidth=4,bg="misty rose" ,justify='right')
...
textCheese_hamburger = Entry(frame1,font=('ariel' ,16,'bold'),
textvariable=Cheese_hamburger , bd=6,insertwidth=4,bg="light blue" ,justify='right')
...
textDrinks = Entry(frame1,font=('ariel' ,16,'bold'), textvariable=Drinks ,bd=6,insertwidth=4,bg="misty rose" ,justify='right')
...
textService_Charge = Entry(frame1,font=('ariel' ,16,'bold'), textvariable=Service_Charge, bd=6,insertwidth=4,bg="misty rose" ,justify='right')
...
labelhamburgertotal = Label(frame1, font=( 'aria' ,16, 'bold'),text="Total",fg="black",bd=10,anchor='w')
labelhamburgertotal.grid(row=4,column=2)
texthamburgertotal = Entry(frame1,font=('ariel' ,16,'bold'), textvariable=hamburgertotal ,bd=6,insertwidth=4,bg="misty rose" ,justify='right')
texthamburgertotal.grid(row=4,column=3)
labelTotal = Label(frame1, font=( 'aria' ,16, 'bold' ),text="Grand Total",fg="black",bd=10,anchor='w')
...
buttonTotal=Button(frame1,padx=16,pady=8, bd=10 ,fg="black",font=('ariel',16,'bold'),width=10, text="TOTAL", bg="khaki1",command=Ref)
buttonTotal.grid(row=7, column=1)
buttonreset=Button(frame1,padx=16,pady=8, bd=10 ,fg="black",font=('ariel',16,'bold'),width=10, text="RESET", bg="khaki1",command=reset)
buttonreset.grid(row=7, column=2)
buttonexit=Button(frame1,padx=16,pady=8, bd=10 ,fg="black",font=('ariel',16,'bold'),width=10, text="EXIT", bg="khaki1",command=qexit)
...
def price():
 ...
 labelinformation.grid(row=0, column=0)
 labelinformation = Label(ws, font=('aria', 15,'bold'), text="_____", fg="white",anchor=W)
 ...
 ws.mainloop()
buttonprice=Button(frame1,padx=16,pady=8, bd=10 ,fg="black",font=('ariel',16,'bold'),width=10, text="PRICE", bg="khaki1",command=price)
